...
<head>
    ...
    <title>Каталог принтеров — мобильный макет</title>
    ...
    <style>
        :root {
            ...
            --line: #e7eaf0;
            --blue: #2f6df6;
            --blue-soft: rgba(47, 109, 246, 0.12);
            --shadow: 0 18px 40px rgba(18, 23, 38, 0.08);
            --shadow-soft: 0 10px 25px rgba(18, 23, 38, 0.05);
            --radius-xl: 28px;
            --radius-lg: 22px;
            --radius-md: 18px;
            --radius-sm: 14px;
        ...
        * {
        ...
        html, body {
            margin: 0;
            min-height: 100%;
            background: radial-gradient(circle at top, #ffffff 0%, var(--bg) 52%, #eef1f6 100%);
        ...
        .pill.active {
            border-color: rgba(47, 109, 246, 0.9);
            color: var(--blue);
            box-shadow: 0 0 0 1px rgba(47, 109, 246, 0.08) inset;
            background: #fff;
        }
        ...
        .printer-card:active {
            ...
            box-shadow: 0 8px 20px rgba(18, 23, 38, 0.04);
        }
        ...
        .printer-placeholder {
            ...
            height: 100%;
            border-radius: 24px;
            border: 1px dashed rgba(110, 121, 140, 0.28);
            background:
                radial-gradient(circle at 50% 35%, rgba(255,255,255,0.9) 0 32%, transparent 33%),
                linear-gradient(180deg, rgba(255,255,255,0.1), rgba(255,255,255,0.1)),
                linear-gradient(180deg, #eef2f7 0%, #fbfcfe 55%, #edf1f6 100%);
            position: relative;
            overflow: hidden;
            display: flex;
            align-items: center;
        ...
        .printer-placeholder::before {
            ...
            border-radius: 999px;
            box-shadow: 0 10px 25px rgba(18, 23, 38, 0.05);
        }
        ...
        .empty-placeholder {
            height: 100%;
            border-radius: 24px;
            border: 1px dashed rgba(110, 121, 140, 0.18);
...
<main class="phone-shell">
    <div class="page">
        <header class="topbar">
            <div class="toolbar">
                <button class="menu-btn" type="button" aria-label="Открыть меню">
                    <div class="menu-icon"><span></span></div>
                </button>

                <nav class="filter-row" aria-label="Категории и фильтры">
                    <button class="pill active" type="button">Все</button>
                    <button class="pill" type="button">МФУ</button>
                    <button class="pill" type="button">Лазерные</button>
                    <button class="pill filter-btn" type="button">
                        <span>⌄</span>
                        <span>Фильтры</span>
                    </button>
                </nav>
        ...
        <section class="content" aria-label="Список принтеров">
            <article class="printer-card" role="button" tabindex="0" aria-label="Открыть принтер HP 1102">
                <div class="photo-frame">
                    <div class="printer-placeholder" aria-hidden="true"></div>
                    ...
                    <div class="features">
                        <div class="feature">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                ...
                                <path d="M8.5 15a3.5 3.5 0 0 1 7 0"></path>
                        ...
                        <div class="feature">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                <rect x="4" y="4" width="6" height="8" rx="1.5"></rect>
                                <rect x="14" y="4" width="6" height="8" rx="1.5"></rect>
        ...
        <section class="catalog-space" aria-label="Пустое место под будущие карточки">
